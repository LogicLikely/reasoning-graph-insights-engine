...
CREATE TABLE public.edges (
    ...
    CONSTRAINT ck_edges_importance_to_parent CHECK (importance_to_parent BETWEEN 1 AND 10),
...
CREATE TABLE public.nodes (
    ...
    log_odds double precision NOT NULL DEFAULT 0,
    evidence jsonb,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT ck_nodes_kind CHECK ((kind = ANY (ARRAY['root'::text, 'claim'::text, 'objection'::text, 'evidence'::text]))),
	CONSTRAINT ck_nodes_log_odds_range CHECK (log_odds BETWEEN -100 AND 100)
);
...
INSERT INTO public.nodes VALUES ('C1', 1, 'claim', 'The horizon looks flat', 'The horizon appears flat to everyday observation.', 'observation', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('C2', 1, 'claim', 'Water finds level', 'Water seeks its level and should not conform to a sphere.', 'physical-intuition', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('C3', 1, 'claim', 'No obvious curvature from altitude', 'Images from balloons and planes do not show obvious curvature.', 'visual-observation', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('C4', 1, 'claim', 'Long-distance visibility seems too great', 'Distant objects are visible farther away than expected on a globe.', 'distance-claims', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('C5', 1, 'claim', 'Mainstream institutions coordinate the narrative', 'Agencies and institutions reinforce a globe narrative that should be questioned.', 'meta-claim', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('P1', 1, 'claim', 'Beach and ocean horizons appear straight', 'At sea level, the horizon usually appears flat and level.', 'observation', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('P2', 1, 'claim', 'Canals and lakes look level', 'Large bodies of water appear level over long distances.', 'observation', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
...
INSERT INTO public.nodes VALUES ('P4', 1, 'claim', 'Balloon footage can look flat', 'Some high-altitude footage appears to show a flat horizon.', 'visual-observation', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('P5', 1, 'claim', 'Distant skylines remain visible', 'Some city skylines or mountains appear visible from surprising distances.', 'distance-claims', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('P6', 1, 'claim', 'Laser and line-of-sight tests look level', 'Some amateur tests report level measurements over water.', 'measurement', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('E1', 1, 'evidence', 'Photographs from beaches', 'Collections of beach and ocean photographs are cited as visual support.', NULL, '{}', 0, '{"type": "observational", "score": 0.52, "rationale": "Visual examples are easy to gather but hard to interpret precisely."}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('E2', 1, 'evidence', 'Canal observations', 'Flat-earth arguments often cite calm water surfaces and canal observations.', NULL, '{}', 0, '{"type": "observational", "score": 0.5}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('E3', 1, 'evidence', 'Passenger flight photos', 'Passenger photos and videos from aircraft are used as support.', NULL, '{}', 0, '{"type": "video", "score": 0.46}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('E4', 1, 'evidence', 'Balloon video clips', 'Selected balloon footage is cited as evidence that curvature is not obvious.', NULL, '{}', 0, '{"type": "video", "score": 0.47}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('E5', 1, 'evidence', 'Long-distance photo examples', 'Photos of distant buildings and mountains are used to argue visibility is too great.', NULL, '{}', 0, '{"type": "observational", "score": 0.49}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('E6', 1, 'evidence', 'Amateur measurement experiments', 'Laser tests, zoom tests, and line-of-sight measurements are cited in support.', NULL, '{}', 0, '{"type": "experimental", "score": 0.44}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('O1', 1, 'objection', 'Human perception is a poor curvature detector', 'At normal scales, human vision is not a reliable way to detect Earth''s curvature.', 'visual-limit', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('O2', 1, 'objection', 'Atmospheric refraction affects visibility', 'Refraction can make distant objects appear higher or more visible than expected.', 'optics', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('O3', 1, 'objection', 'Water level locally does not imply global flatness', 'A surface can be locally level while still conforming to a sphere.', 'geometry', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('O4', 1, 'objection', 'Camera lenses can distort curvature', 'Lens choice, framing, and post-processing can affect whether curvature appears visible.', 'imaging', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('O5', 1, 'objection', 'Balloon footage is not a controlled measurement', 'Anecdotal video clips are weaker than calibrated measurement.', 'methodology', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('O6', 1, 'objection', 'Distance claims depend on elevation and hidden-height math', 'Visibility calculations depend on observer height, object height, and atmospheric conditions.', 'geometry', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('O7', 1, 'objection', 'Amateur tests often lack controls', 'DIY experiments frequently omit calibration, repeatability, and environmental controls.', 'methodology', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('O8', 1, 'objection', 'Institutional agreement is not by itself evidence of conspiracy', 'Broad agreement can reflect converging evidence rather than coordinated deception.', 'meta-claim', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
INSERT INTO public.nodes VALUES ('O9', 1, 'objection', 'Multiple support branches rely on the same observational weakness', 'Several flat-earth arguments share the same limitations of casual observation.', 'cross-cutting', '{}', 0, '{}', '2026-04-13 11:42:53.694065-04', '2026-04-13 11:42:53.694065-04');
