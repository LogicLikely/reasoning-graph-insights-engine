...
public class OperationRegistryTests
{
    ...
    public void Registry_HasExactFrozenOrderAndMetadata()
    {
        var expected = new[]
        {
            ...
            (OperationKeys.GraphSearch, "Find matches and the complete required ancestor union.",
                AlgorithmSemanticIdentities.GraphSearchV1,
                OperationExposure.BenchmarkDiagnostic, OperationResultSurface.MatchAndAncestorUnionCountsAndOptionalProjection),
            (OperationKeys.PathStrongest, "Find strongest paths in the requested direction.",
                AlgorithmSemanticIdentities.StrongestPathV1,
                OperationExposure.AnalysisAndBenchmark, OperationResultSurface.SummaryRankedOrderedPathsAndOptionalGraphContext),
            ...
            (OperationKeys.CounterCriticalSet, "Find a threshold-reaching counter set with exact, greedy, or auto strategy.",
                ...
                OperationExposure.AnalysisAndBenchmark, OperationResultSurface.SelectedCountersQualityAndOptionalGraphContext),
