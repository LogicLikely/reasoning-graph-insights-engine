...
\texttt{GraphLikelihoodCalculator} and the legacy
\texttt{ImportanceToParent}-based path model.  They are intentionally not part
of the posterior-odds integration described here and can therefore disagree
with a posterior produced by the conditional-probability BF recurrence.  They
should be migrated separately once BF-based definitions for those analytics
are specified.
